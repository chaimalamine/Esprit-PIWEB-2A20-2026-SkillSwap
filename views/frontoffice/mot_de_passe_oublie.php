...
<head>
    ...
    <title>Mot de passe oublié - SkillSwap</title>
    <style>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <?php if(isset($_SESSION['reset_sent'])): ?>
                <div class="success-message"><?php echo $_SESSION['reset_sent']; unset($_SESSION['reset_sent']); ?></div>
            <?php endif; ?>
            
            <form action="http://localhost/projetwebfinal/controllers/UserC.php?action=sendResetLink" method="POST">
